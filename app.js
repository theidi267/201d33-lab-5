...
var multString = 'The product of ' + a + ' and ' + b + ' is ' + multNum + '.';
  //return an array
return [multNum, multString];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  //add three numbers with the sum function

  var firstAddition = sum(a, b)[0]; 
  var secondAddition = sum(c, firstAddition)[0];
  
  //muliply three numbers using multiply function
...
function multiplyArray(testArray) { //eslint-disable-line
  ...
  var firstMultipl = multiply(testArray[0], testArray[1])[0]
  var secondMultipl = multiply(testArray[2], firstMultipl)[0]

  var returnString = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + secondMultipl + '.'

  return [secondMultipl, returnString]
